document.addEventListener('DOMContentLoaded', (e) => {
  ...
  priceSort.addEventListener('change', (e) => {
      ...
      window.location.href = `/filterBrandSort?brand=${brand}&sortValue=${sortValue}&criteria=unitPrice`;
  });
...
dateSort.addEventListener('change', (e) => {
    ...
    window.location.href = `/filterBrandSort?brand=${brand}&sortValue=${sortValue}&criteria=createdAt`;
});
